...
* **Quick deploy**: If you are in a hurry, you can build, push and deploy a container directly to server with the `taito ci-quickdeploy:ENV NAME` command e.g. `taito ci-quickdeploy:dev client`.
