...
gcloud_org_id="${template_default_provider_org_id:?}"  # NOTE: leave empty for 'no organization'
...
"
taito_secret_commands="
  start:local=dev:${taito_project}-${taito_env}-gserviceaccount.key
"
