...
Generate code:
    ...
    taito code generate                     # Generate code for all
    taito code generate userGroup           # Generate code for userGroup entity
    taito code generate:server userGroup    # Generate server code for userGroup entity
...
If your implementation supports code generation, you can execute it with `taito code generate`. For example:
    ...
    taito code generate                     # Generate code for all
    taito code generate userGroup           # Generate code for userGroup
    taito code generate:server userGroup    # Generate server code for userGroup
